...
const goToNext = () => {
  ...
  if (position === maxVisiblePages - 1 && nextPage <= props.totalPages) {
      ...
      <button
        ...
        :class="[
          ...
          isFirstDisabled
            ...
            : 'text-blue-600 hover:text-white hover:bg-blue-500 active:bg-blue-600',
        ]"
      >
        First
      </button>
        ...
        <button
          ...
          :class="[
            ...
            currentPage === page
              ...
              : 'text-blue-600 hover:text-black hover:bg-blue-500 active:bg-blue-600',
          ]"
