...
watchEffect(async () => {
  if (localStorage.getItem("noti_success_edit_profile")) {
    showSuccessModal.value = true;
    localStorage.removeItem("noti_success_edit_profile");
  }
  try {
    if (userInfo.value) {
      const headers = {
...
<template>
  ...
  >
              ...
              <div class="text-center md:text-left flex-1">
                ...
                >
                  ...
                  <router-link
                    ...
                    class="itbms-profile-button bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white border-2 border-white/30 hover:border-white/50 px-6 py-3 rounded-2xl font-semibold transition-all duration-300 flex items-center gap-2 mx-auto md:mx-0"
                  >
                    <svg
                ...
                >
                  <div
                    class="badge badge-lg bg-gradient-to-r from-yellow-400 to-orange-400 text-white border-0 px-4 py-2 rounded-full"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4 mr-2"
          ...
          <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div class="form-control group">
                ...
                <input
                  type="text"
                  :value="userInfoLocal.nickName"
                  class="input itbms-type bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 focus:border-purple-400 focus:bg-white transition-all duration-300 text-xl font-medium py-4 px-6 rounded-2xl"
                  readonly
                />
              </div>
              ...
              <div class="form-control group">
                ...
                <div
                  class="input itbms-email bg-gradient-to-r from-emerald-50 to-teal-50 border-2 border-emerald-200 focus:border-emerald-400 focus:bg-white transition-all duration-300 text-xl font-medium py-4 px-6 rounded-2xl"
                >
                  {{ userInfoLocal.email }}
                </div>
              </div>
              ...
              <div class="form-control md:col-span-2 group">
                ...
                <div
                  class="input bg-gradient-to-r itbms-fullname from-orange-50 to-red-50 border-2 border-orange-200 focus:border-orange-400 focus:bg-white transition-all duration-300 text-xl font-medium py-4 px-6 rounded-2xl"
                >
                  {{ userInfoLocal.fullName }}
                </div>
                <input
                  type="text"
                  readonly
                  class="opacity-0 input bg-gradient-to-r itbms-fullname from-orange-50 to-red-50 border-2 border-orange-200 focus:border-orange-400 focus:bg-white transition-all duration-300 text-xl font-medium py-4 px-6 rounded-2xl"
                  :value="userInfoLocal.fullName"
                />
              </div>
            </div>
          </div>
            ...
            <div class="mb-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="form-control group">
                  ...
                  <div class="relative">
                    <div
                      class="input itbms-mobile bg-gradient-to-r from-pink-50 to-rose-50 border-2 border-pink-200 focus:border-pink-400 focus:bg-white font-mono text-xl tracking-wider transition-all duration-300 pr-16 py-4 px-6 rounded-2xl"
                    >
                      {{ maskData(userInfoLocal.mobile) }}
                    </div>
                    <div
                ...
                <div class="form-control group">
                  ...
                  <div
                    class="input itbms-bankName bg-gradient-to-r from-indigo-50 to-blue-50 border-2 border-indigo-200 focus:border-indigo-400 focus:bg-white transition-all duration-300 text-xl font-medium py-4 px-6 rounded-2xl"
                  >
                    {{ userInfoLocal.bankName }}
                  </div>
                </div>
                ...
                <div class="form-control group">
                  ...
                  <div class="relative">
                    <div
                      class="input itbms-bankAccount bg-gradient-to-r from-yellow-50 to-amber-50 border-2 border-yellow-200 focus:border-yellow-400 focus:bg-white font-mono text-xl tracking-wider transition-all duration-300 pr-16 py-4 px-6 rounded-2xl"
                    >
                      {{ maskData(userInfoLocal.bankAccount) }}
                    </div>
                    <div
                ...
                <div class="form-control group">
                  ...
                  <div class="relative">
                    <div
                      class="input bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 focus:border-red-400 focus:bg-white font-mono text-xl tracking-wider transition-all duration-300 pr-16 py-4 px-6 rounded-2xl"
                    >
                      {{ maskData(userInfoLocal.cardNo) }}
                    </div>
                    <div
    ...
    >
      <div
        class="bg-white rounded-3xl p-8 max-w-md w-full mx-4 transform shadow-2xl"
      >
        <div class="text-center">
          <!-- Success Icon -->
          <div
            class="mx-auto w-20 h-20 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center mb-6 animate-pulse"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <!-- Success Message -->
          <h2
            class="text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-4"
          >
            สำเร็จ!
          </h2>
          <p class="text-xl text-gray-700 mb-8">
            Profile data is updated successful
          </p>

          <!-- Close Button -->
          <button
            @click="showSuccessModal = false"
            class="btn bg-gradient-to-r from-green-400 to-emerald-500 hover:from-green-500 hover:to-emerald-600 text-white border-0 px-8 py-3 rounded-2xl font-semibold transition-all duration-300 flex items-center gap-2 mx-auto"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
