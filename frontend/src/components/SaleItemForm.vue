...
const uploadImage = (event) => {
  ...
  // เช็คว่าเลือกเกิน 4 รูปหรือไม่
  if (files.length > 4) {
    alert("Maximum 4 pictures are allowed.");
  }
  
  // นับเฉพาะภาพที่มีจริง (ไม่ใช่ deleted/empty)
  ...
  // เอาแค่ 4 ตัวแรกและไม่เกิน availableSlots
...
const activeImages = computed(() =>
  images.value.filter((img) => !img.isDeleted)
);
...
const handleSubmit = async () => {
  ...
  formData.append(
    "screenSizeInch",
    form.screenSizeInch != null ? Number(form.screenSizeInch) : ""
  );
  formData.append(
    "storageGb",
    form.storageGb != null ? Number(form.storageGb) : ""
  );
  formData.append("color", form.color?.trim() || "");
  formData.append(
    "quantity",
    form.quantity != null ? Number(form.quantity) : ""
  );
  // แนบรูปภาพ
  images.value
    .filter((img) => !img.isDeleted && img.file)
    .forEach((img, idx) => {
      ...
      >
        ...
        <div class="mb-8">
          <div class="flex flex-col items-center gap-4">
            <!-- Preview ภาพใหญ่ -->
            <div
              class="border-2 rounded-2xl w-64 h-64 flex items-center justify-center"
            >
              <img
                :src="showImage"
            ...
            <!-- Thumbnails -->
            <div
              class="flex gap-4 mt-4 w-full justify-center items-center overflow-auto"
            >
              <div
              ...
              >
                ...
                <div
                  ...
                  class="max-h-20 h-20 w-14 border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center bg-gray-50 opacity-60"
                >
                  <svg
                ...
                <div
                  ...
                  class="max-h-20 h-20 w-14 border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center bg-gray-50"
                >
                  <svg
                    class="w-6 h-6 text-gray-400"
                    fill="none"
                ...
                <img
                  v-else
                  class="max-h-20 h-20 w-14 border object-cover rounded-2xl cursor-pointer"
                  :src="image.src"
                  alt=""
                  :class="
                ...
                <div class="text-xs mt-1">
                  <span
                    ...
                    >Deleted</span
                  >
                  <span v-else-if="image.isEmpty" class="text-gray-400"
                    >Empty</span
                  >
                  <span
                    v-else-if="image.isOriginal"
                ...
                <div
                  ...
                  v-if="!image.isDeleted && !image.isEmpty"
                >
                  <!-- ปุ่ม Up -->
                  <button
                    type="button"
                  ...
                  >
                    <img
                      class="w-3 h-3"
                      src="/src/assets/bxs--up-arrow.svg"
                      alt="Up"
                    />
                  </button>
                  ...
                  >
                    <img
                      class="w-3 h-3"
                      src="/src/assets/bxs--down-arrow.svg"
                      alt="Down"
                    />
                  </button>
            ...
            <div class="flex flex-col items-center gap-2 mt-2">
              ...
              <p class="text-sm text-gray-500">
                {{ images.filter((img) => !img.isDeleted).length }}/4 images
                uploaded
              </p>
            </div>
